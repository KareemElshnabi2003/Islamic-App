...
import 'package:islamic_app/features/home/quran/presentation/cubit/all_sour_state.dart';
          ...
          child: Column(
            children: [
              ...
              Padding(
                ...
                child: Row(
                  children: [
                    Expanded(child: Center(child: TextNormalWidget(decorationColor: theme.textTheme.titleLarge!.color!,text: "اسم السورة", size: 20.sp, color: theme.textTheme.titleLarge!.color!, decoration: TextDecoration.none, maxLines: 1, weight: FontWeight.bold))),
                    SizedBox(width: 10.w, child: LineWidget(color: theme.dividerColor, isVertical: true, thick: 4, size: 5.7.h)),
                    Expanded(child: Center(child: TextNormalWidget(decorationColor: theme.textTheme.titleLarge!.color!,text: "نوع السورة", size: 20.sp, color: theme.textTheme.titleLarge!.color!, decoration: TextDecoration.none, maxLines: 1, weight: FontWeight.bold))),
                  ],
                ),
              ),
              LineWidget(color: theme.dividerColor, isVertical: false, thick: 4, size: 100.w),
                        ...
                        return ListView.builder(
                          ...
                          itemBuilder: (context, index) {
                            ...
                            return InkWell(
                              ...
                              child: Row(
                                children: [
                                  Expanded(child: Center(child: TextNormalWidget( decorationColor: theme.textTheme.titleLarge!.color!,text: sura.name, size: 19.sp, color: theme.textTheme.titleLarge!.color!, decoration: TextDecoration.none, maxLines: 1, weight: FontWeight.w600))),
                                  SizedBox(width: 10.w, height: 6.h, child: LineWidget(color: theme.dividerColor, isVertical: true, thick: 4, size: 5.h)),
                                  Expanded(child: Center(child: TextNormalWidget(decorationColor: theme.textTheme.titleLarge!.color!,text: sura.makia == 1 ? "مكية" : "مدنية", size: 19.sp, color: theme.textTheme.titleLarge!.color!, decoration: TextDecoration.none, maxLines: 1, weight: FontWeight.w600))),
                                ],
                              ),
                            );
                          },
