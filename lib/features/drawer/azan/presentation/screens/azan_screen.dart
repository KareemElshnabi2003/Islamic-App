...
class _AdhanSettingsScreenState extends State<AdhanSettingsScreen> {
  ...
  void initState() {
    super.initState();
    // تحديث البيانات كل مرة نفتح فيها الشاشة تحسباً لو تم جلب المواقيت مؤخراً
