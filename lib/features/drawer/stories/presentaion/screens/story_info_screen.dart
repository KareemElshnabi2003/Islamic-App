...
class StoryInfoScreen extends StatefulWidget {
  ...
  @override
  State<StoryInfoScreen> createState() => _StoryInfoScreenState();
}
                    ...
                    child: Column(
                      ...
                      children: [
                        Row(
                          ...
                          children: [
                            TextNormalWidget(text: "قصه النبي يوسف", size: 16.sp, color: theme.textTheme.titleLarge!.color!, decoration: TextDecoration.none, decorationColor: theme.textTheme.titleLarge!.color!, maxLines: 1, weight: FontWeight.w700),
                            SizedBox(width: 15,),
